...
public interface CustomerMapper {
    ...
    @Select("select customer_id,username from ht_customer where customer_name = #{customer_name} and customer_password = #{password}")
    CustomerEntity login(String customer_name,String password);
